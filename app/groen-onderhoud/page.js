  ...
  heroSection:
      {
        ...
        subTitle: "Als specialist in groenonderhoud helpen we gemeenten en andere overheidsinstellingen met het onderhouden van groen in de openbare ruimte. Ook verzorgen we het onderhoud van zakelijke buitenruimtes zoals bedrijventerreinen, binnen tuinen en dakterrassen.",
        backGroundImage: "/assets/images/big-green/hero/hero-big-green.png",
      },
    uspSection: [
      {
        title: "Snoeien en trimmen",
        description: "We snoeien en trimmen planten en struiken zodat deze een goede gezondheid behouden. Ook bevordert het de groei, voorkomt overwoekering en zorgt het voor een nette buitenruimte.",
      ...
      },
      {
        ...
        description: "We gebruiken milieuvriendelijke technieken en werken met inheemse planten. Dit draagt bij aan een duurzame buitenruimte en bevordert biodiversiteit.",
        iconUrl: "/assets/images/big-green/icon-sustainability.svg"
      },
    ],
    ctaSection: {
      ctaTitle: "We denken graag me je mee",
    ...
    articleSection:
    {
      ...
      articleDescription: {
        ...
        paragraph4: "Door efficiënte planning en uitvoering van onderhoudstaken worden lange termijn kosten verlaagd en grote herstelwerkzaamheden voorkomen. Ook voorkomt het onveilige situaties die – bijvoorbeeld - losliggende tegels en overwoekerde bewegwijzering kunnen veroorzaken."
      },
      articleImage1: {
